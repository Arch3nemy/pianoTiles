package com.alacrity.template.game
...
import com.alacrity.template.data.R
import com.alacrity.template.entity.Tile
import java.util.*
...
class GameView(context: Context) : SurfaceView(context), SurfaceHolder.Callback {
    ...
    private val thread: String? = null
    ...
    init {
     ...
     //   thread = null//GameThread(holder, this)
